package br.com.jkavdev.groups.event.listener;
...
public class PropertiesLoggerListener implements ApplicationListener<ApplicationPreparedEvent> {

    private static final Logger log = LoggerFactory.getLogger(PropertiesLoggerListener.class);
...
//        evitando que exibar as informacoes do application.properties
//        printProperties();
    }
