...
--
-- Table structure for table `noticia_hits`
--

DROP TABLE IF EXISTS `noticia_hits`;
...
--
-- Dumping data for table `noticia_hits`
--

LOCK TABLES `noticia_hits` WRITE;
/*!40000 ALTER TABLE `noticia_hits` DISABLE KEYS */;
/*!40000 ALTER TABLE `noticia_hits` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-09-16 10:49:32
